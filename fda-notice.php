...
<div class="breadcrumb">
  <div class="breadcrumb__inner">
    ...
    <span class="breadcrumb__current">FDA Notice</span>
  </div>
</div>
...
<section class="legal">
  <div class="legal__inner">
    <div class="legal__header">
      ...
      <h1 class="fade-up stagger-1">FDA Notice &amp; Research Use Disclaimer</h1>
      <hr class="teal-rule teal-rule--wide teal-rule--center fade-up stagger-2" style="margin:16px auto;">
      <p class="legal__updated fade-up stagger-2">Effective Date: March 30, 2026</p>
    </div>

    <div class="legal__body fade-up stagger-3">

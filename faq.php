  ...
  <div class="faq__inner">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item fade-up" data-category="ordering">
        ...
        <div class="faq-answer">
          <div class="faq-answer__inner">We use an invoice-based payment system. After placing your order, you'll receive an invoice with payment instructions. We accept Zelle, Venmo, and Cash App — each with a QR code you can scan to pay. All transactions are processed securely.</div>
        </div>
      </div>
